 ...
 * 12/08/2021
 * 
 * Test the bounce force on a rigidbody.
 */
...
int main(int argc, char *argv[])
{
    ...
    Vector up;
    vector_set(&up, 0, 1, 0);
    Force *bounceUp = force_createp(&up, 150);
    ...
    for (int i = 0; i < nFrames; i++)
    {
        ...
        char buffer[256];
        sprintf(buffer, "final/testbounce/testbounce_frame%03d.ppm", i);
